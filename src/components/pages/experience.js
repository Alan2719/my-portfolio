        ...
        <Container>
            <div class="card mb-3">
                <div class="row no-gutters">
                    ...
                    <div class="card-body experience-card">
                        <h6 class="card-title experience-text"><strong>Ford Motor Company | February 2020 | Junior Engineer</strong></h6>
            ...
            <div class="card mb-3">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8 experience-card">
                    <div class="card-body experience-card">
                        <h6 class="card-title experience-text"><strong>Eagleburgmann | June 2018 - May 2019 | Project Engineer</strong></h6>
